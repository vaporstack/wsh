...
void recorder_init(void)
{
	...
	test_geometry.src = w_object_create(NULL);
	/*
	WLine* src = w_line_create();
	work_line = w_line_hnd_create_with_addr(src);
	test_geometry = w_object_hnd_create(NULL);
	test_geometry->src = w_object_create(NULL);
	*/
}
...
void recorder_clear(void)
{
	...
	w_object_destroy(test_geometry.src);
